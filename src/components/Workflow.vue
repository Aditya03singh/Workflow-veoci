<template>
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="item in details" :key="item.id" class="tr border">
              <td class="td"><button class="btn">Show</button></td>
              <td class="td">
                <button class="btn" @click="openPopUp">Create</button>
              </td>
              <td class="td"><button class="btn">Edit</button></td>
    ...
    <div v-if="showPopUp" class="select-container">
      <div class="show">
        ...
        <div class="show-buttons">
          ...
          <button class="launch-btn" @click="launch" :disabled="!selectedRoom">Launch Workflow</button>
        </div>
      </div>
    </div>
  </template>
  ...
  <script>
  // import Workflow_launch from './Workflow_launch.vue';
  export default {
    name: "Workflow",
    data() {
      return {
